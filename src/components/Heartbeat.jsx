        ...
        <AreaChart data={forecastData} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
          <defs>
            <linearGradient id="glowGradient" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#00E5FF" stopOpacity={0.05}/>
          ...
          <XAxis 
            ...
            axisLine={false} 
            tickLine={false} 
            tick={{ fill: '#475569', fontSize: 9, family: 'JetBrains Mono', fontWeight: 600 }}
            interval={14}
          />
          ...
          <Tooltip 
            ...
            cursor={{ stroke: 'rgba(0, 229, 255, 0.1)', strokeWidth: 1 }}
          />
          <Area 
            type="monotone" 
            dataKey="balance" 
